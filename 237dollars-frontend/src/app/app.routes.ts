...
export const routes: Routes = [
  ...
  { path: 'references', loadComponent: () => import('./pages/references/references-list/references-list.component').then(m => m.ReferencesListComponent) },
  { path: 'references/major/:id', loadComponent: () => import('./pages/references/topics-list/topics-list.component').then(m => m.TopicsListComponent) },
  { path: 'references/topic/:id', loadComponent: () => import('./pages/references/references-by-topic/references-by-topic.component').then(m => m.ReferencesByTopicComponent) },
  { path: 'references/:id', loadComponent: () => import('./pages/references/reference-detail/reference-detail.component').then(m => m.ReferenceDetailComponent) },
